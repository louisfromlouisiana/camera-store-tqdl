...
import { useUpdateProductMutation } from '../../../services/redux/query/products';
import {
...
function UpdateProductModal() {
  ...
  const handleSubmit = useCallback(
    async (e) => {
      ...
      data.append('editImages', JSON.stringify(form.editImages));
      data.append('description', form.description);
      data.append('price', form.price);
      data.append('quantity', form.quantity);
      data.append('oldQuantity', form.oldQuantity);
      ...
      await updateProduct({
        id: state.visibleUpdateProductModal?._id,
        body: data,
      });
    },
    [updateProduct, form]
  ...
  useEffect(() => {
    if (isSuccessUpdateProduct && UpdateProductData) {
      setVisibleModal({
        visibleToastModal: {
          type: 'success',
          message: UpdateProductData?.message,
        },
      });
      setForm(() => {
        return {
    ...
    if (isErrorUpdateProduct && errorUpdateProduct) {
      setVisibleModal({
        visibleToastModal: {
          type: 'error',
          message: errorUpdateProduct?.data?.message,
        },
      });
    }
  }, [
        ...
        >
          <div className='px-4 py-4 sm:py-6 flex justify-between items-center gap-4 bg-neutral-200'>
            ...
            <button
              ...
              onClick={() => setVisibleModal('visibleUpdateProductModal')}
            >
                      ...
                      >
                        ...
                        <button
                          ...
                          onClick={() =>
                            setForm({
                              ...form,
                              editImages: form.editImages.filter(
                                (_, index) => index !== i
                              ),
                            })
                          }

...
function ConfirmModal() {
  ...
  return (
    ...
    >
      <div
        className='bg-neutral-100 text-neutral-700 border border-neutral-300 py-8 px-4 md:px-6 rounded-lg flex flex-col gap-[26px]'
        ref={modalRef}
        disabled={state.visibleConfirmModal?.loading}
      >
        <div className='px-8 pb-4 flex flex-col items-center gap-[20px]'>
        ...
        <div className='flex justify-center items-center gap-[24px] text-sm'>
          <button
            ...
            className='h-[48px] bg-neutral-500 hover:bg-neutral-600 text-white p-4 flex justify-center items-center rounded-md'
          ...
          <button
            type='button'
            style={{ transition: 'all 0.2s linear' }}
            className='h-[48px] text-white bg-violet-500 hover:bg-violet-700 p-4 flex justify-center items-center rounded-md'

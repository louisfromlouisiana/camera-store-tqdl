...
function Pagination({ curPage, totalPage }) {
  ...
  return (
    <ReactPaginate
      ...
      className='my-2 mx-4 flex justify-center items-stretch gap-[10px] font-bold text-neutral-700 py-2'
      nextLabel={
        <button className='flex items-center gap-2 px-4 border border-neutral-300 py-2 text-neutral-500 text-sm'>
          <p>Next</p>
          <FaAnglesRight />
        </button>
      }

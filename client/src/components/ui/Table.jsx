    ...
    <div className='w-full rounded-lg border border-neutral-300 overflow-x-auto overflow-y-auto'>
      ...
      {currPage && totalPage && totalPage > 1 && (
        <ReactPaginate
          ...
          className='my-2 mx-4 flex justify-end items-center gap-[10px] font-bold text-neutral-700 py-2'
          nextLabel={<TbChevronRight className='text-neutral-700' />}
          onPageChange={handlePageClick}
          pageRangeDisplayed={2}
          marginPagesDisplayed={2}
          pageCount={totalPage}
          previousLabel={<TbChevronLeft className='text-neutral-700' />}
          ...
          activeClassName='bg-neutral-700 rounded-[4px] text-white'

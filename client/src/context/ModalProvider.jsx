...
// Thêm nhiều state modal vào đây
const initialState = {
  visibleToastModal: null,
  visibleFavoriteModal: null,
  visibleCartModal: null,
  visibleUserModal: false,
  visibleAddProductModal: false,
  visibleUpdateProductModal: null,
  visibleAddSpecificationModal: false,
  visibleUpdateSpecificationModal: null,
  visibleAddBannerModal: false,
  visibleUpdateBannerModal: null,
  visibleAddAddressModal: false,
  visibleUpdateAddressModal: null,
  visibleListAddressModal: false,
  visibleAddVoucherModal: false,
  visibleUpdateVoucherModal: null,
  visibleReviewsModal: null,
  visibleChangePasswordModal: false,
  visibleAddCouponModal: false,
  visibleConfirmModal: null,
  visibleReplyModal: null,
  visibleImageModal: null,
